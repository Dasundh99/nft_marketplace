...
//       // call on-chain listing helper
//       // NOTE: we pass `wallet` as the adapter argument. Your solana helper expects a WalletAdapter.
//       // If your helper expects wallet.adapter, change accordingly — but avoid wallet.adapter because some useWallet versions don't expose it.
...
//       // txOrTradeState may be signature string or tradeState address; we'll keep both in Firestore field txSignature
//       const txSignature =
...
//       // Use addDoc so Firestore generates an id
//       const docRef = await addDoc(collection(db, "listings"), newListing);

//       // also update the doc with its id if you like
//       await updateDoc(doc(db, "listings", docRef.id), { id: docRef.id });

//       closeInlineForm();
//       alert("Listing created on-chain and stored in Firestore.");
//     } catch (err: any) {

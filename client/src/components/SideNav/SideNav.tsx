...
import { IoBasket, IoBoat } from "react-icons/io5";
...
const SideNav: React.FC<SideNavProps> = ({ isExpanded, setIsExpanded }) => {
  const menuItems = [
    ...
    { icon: <IoBoat className="w-5 h-5" />, label: "Shipping", path: "/Shipping" },
    { icon: <IoBasket className="w-5 h-5" />, label: "Tracking View", path: "/trackingview" },
  ];
